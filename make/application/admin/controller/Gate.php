...
class Gate extends AdminBase
{
    ...
    public function setting()
    {
        ...
        $data['service_weixin'] = isset($data['service_weixin']) ? $data['service_weixin'] : '15019244212';
        $data['service_email'] = isset($data['service_email']) ? $data['service_email'] : 'diandong2018@163.com';
        if ($this->request->isAjax()) {
